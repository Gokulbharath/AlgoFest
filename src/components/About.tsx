...
import LLKLogo from '../assets/LearnLogicify Logo.jpg'; // ensure this file exists (case-sensitive)
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex justify-center mb-6">
          <img
            src={KitLogo}
            alt="KIT Logo"
            className="h-[5cm] w-[5cm] object-cover rounded-full shadow-lg"
          />
        </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <div className="flex items-baseline gap-4">
                      ...
                      <span className="text-2xl md:text-3xl font-semibold text-gray-400 line-through">₹199</span>
                    </div>
                    <div className="mt-2">
